...
export const soundCues:Record<SoundCue,SoundDefinition>={
  ...
  wallContact:{file:'/audio/arena-tap.wav',volume:.58,rate:.9,variance:.08,cooldownMs:34},
  ...
  materialWall:{file:'/audio/arena-tap.wav',volume:.3,rate:.9,variance:.1,cooldownMs:38},
  ...
  heal:{file:'/audio/healing.wav',volume:.22,rate:1.1,variance:.04,cooldownMs:260},
  coin:{file:'/audio/goldie-coin.wav',volume:.75,rate:1,variance:.05,cooldownMs:70},
  jackpot:{file:'/audio/goldie-coin.wav',volume:1,rate:.72,variance:.02,cooldownMs:180},
  ...
  lanceCharge:{file:'/audio/lance-whoosh.wav',volume:.42,rate:.9,variance:.04,cooldownMs:180},
  lanceHit:{file:'/audio/lance-hit.wav',volume:.58,rate:.78,variance:.05,cooldownMs:100},
  ...
  success:{file:'/audio/completion.wav',volume:.34,rate:1,cooldownMs:400},
